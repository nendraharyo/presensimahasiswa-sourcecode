...
public abstract class AppCompatDelegate
{
  ...
  public static AppCompatDelegate create(Activity paramActivity, AppCompatCallback paramAppCompatCallback)
  {
    ...
    return create(paramActivity, localWindow, paramAppCompatCallback);
  }
  ...
  public static AppCompatDelegate create(Dialog paramDialog, AppCompatCallback paramAppCompatCallback)
  {
    ...
    return create(localContext, localWindow, paramAppCompatCallback);
  }
  ...
  private static AppCompatDelegate create(Context paramContext, Window paramWindow, AppCompatCallback paramAppCompatCallback)
  {
    ...
    if (i >= j)
    {
      localObject = new android/support/v7/app/AppCompatDelegateImplN;
      ((AppCompatDelegateImplN)localObject).<init>(paramContext, paramWindow, paramAppCompatCallback);
    }
    for (;;)
    {
      return (AppCompatDelegate)localObject;
      i = Build.VERSION.SDK_INT;
      j = 23;
      if (i >= j)
      {
        localObject = new android/support/v7/app/AppCompatDelegateImplV23;
        ((AppCompatDelegateImplV23)localObject).<init>(paramContext, paramWindow, paramAppCompatCallback);
      }
      else
      {
        localObject = new android/support/v7/app/AppCompatDelegateImplV14;
        ((AppCompatDelegateImplV14)localObject).<init>(paramContext, paramWindow, paramAppCompatCallback);
      }
    }
  }
  ...
  public static void setDefaultNightMode(int paramInt)
  {
    ...
    default: 
      ...
      String str2 = "setDefaultNightMode() called with an unknown mode";
      Log.d(str1, str2);
    }
    for (;;)
    {
...
/* Location:              C:\Users\haryo\Desktop\enjarify-master\presensi-enjarify.jar!\android\support\v7\app\AppCompatDelegate.class
