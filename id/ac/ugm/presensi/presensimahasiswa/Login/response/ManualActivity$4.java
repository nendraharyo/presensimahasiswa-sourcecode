...
class ManualActivity$4
  extends AsyncHttpResponseHandler
{
  ManualActivity$4(ManualActivity paramManualActivity) {}
  ...
  public void onFailure(int paramInt, e[] paramArrayOfe, byte[] paramArrayOfByte, Throwable paramThrowable)
  {
    ...
    catch (JSONException localJSONException)
    {
      for (;;)
      {
        try
        {
          boolean bool = ManualActivity.a();
          if (!bool)
          {
            localObject1 = this.a;
            localObject1 = ((ManualActivity)localObject1).getApplicationContext();
            localObject3 = this.a;
            localObject3 = ((ManualActivity)localObject3).getResources();
            i = 2131689796;
        ...
        catch (InterruptedException localInterruptedException)
        {
          ...
          localObject3 = this.a;
          ((ManualActivity)localObject3).b();
          localJSONException.printStackTrace();
          continue;
          Object localObject2 = this.a;
          localObject2 = ((ManualActivity)localObject2).getApplicationContext();
          localObject3 = this.a;
          localObject3 = ((ManualActivity)localObject3).getResources();
          int i = 2131689693;
          localObject3 = ((Resources)localObject3).getString(i);
    ...
    for (;;)
    {
      try
      {
        ...
        if (i == j)
        {
          ...
          String str = "-";
          f.a((Context)localObject2, (String)localObject3, str);
          localObject2 = this.a;
          ((ManualActivity)localObject2).startActivity((Intent)localObject1);
          return;
        }
      }
      catch (JSONException localJSONException)
...
/* Location:              C:\Users\haryo\Desktop\enjarify-master\presensi-enjarify.jar!\id\a\\ugm\presensi\presensimahasiswa\Login\response\ManualActivity$4.class
