    ...
    for (;;)
    {
      try
      {
        ...
        if (bool)
        {
          localObject3 = this.a;
          localObject4 = this.a;
          localObject4 = ((c)localObject4).getActivity();
          str1 = "user_username";
          str2 = "";
          ...
          c.a((c)localObject3, (String)localObject4, str1, (String)localObject1);
          return;
        }
      }
      catch (JSONException localJSONException)
      ...
      localObject3 = this.a;
      localObject4 = this.a;
      localObject4 = c.c((c)localObject4);
      str1 = "token";
      str1 = ((JSONObject)localObject1).getString(str1);
      str2 = "value";
      localObject1 = ((JSONObject)localObject1).getString(str2);
      c.b((c)localObject3, (String)localObject4, str1, (String)localObject1);
    }
  }
}


/* Location:              C:\Users\haryo\Desktop\enjarify-master\presensi-enjarify.jar!\id\a\\ugm\presensi\presensimahasiswa\Home\response\c$4.class
