  ...
  extends AbstractAuthenticationHandler
{
  protected List getAuthPreferences(HttpResponse paramHttpResponse, HttpContext paramHttpContext)
  {
    ...
    String str = "http.auth.target-scheme-pref";
  ...
  public Map getChallenges(HttpResponse paramHttpResponse, HttpContext paramHttpContext)
  {
    ...
    Header[] arrayOfHeader = paramHttpResponse.getHeaders("WWW-Authenticate");
...
/* Location:              C:\Users\haryo\Desktop\enjarify-master\presensi-enjarify.jar!\org\apache\http\impl\client\DefaultTargetAuthenticationHandler.class
