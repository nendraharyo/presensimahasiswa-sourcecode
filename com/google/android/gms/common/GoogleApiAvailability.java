  ...
  extends zzc
{
  ...
  static
  {
    GoogleApiAvailability localGoogleApiAvailability = new com/google/android/gms/common/GoogleApiAvailability;
    localGoogleApiAvailability.<init>();
    zzafE = localGoogleApiAvailability;
  }
  ...
  public Dialog zza(Activity paramActivity, DialogInterface.OnCancelListener paramOnCancelListener)
  {
    ...
    ((ProgressBar)localObject).setIndeterminate(bool);
    ...
    localObject = GooglePlayServicesUtil.zzao(paramActivity);
    Resources localResources = paramActivity.getResources();
    int i = R.string.common_google_play_services_updating_text;
    Object[] arrayOfObject = new Object[bool];
    arrayOfObject[0] = localObject;
    localObject = localResources.getString(i, arrayOfObject);
    localBuilder.setMessage((CharSequence)localObject);
    int j = R.string.common_google_play_services_updating_title;
    localBuilder.setTitle(j);
    localBuilder.setPositiveButton("", null);
    localObject = localBuilder.create();
    GooglePlayServicesUtil.zza(paramActivity, paramOnCancelListener, "GooglePlayServicesUpdatingDialog", (Dialog)localObject);
...
/* Location:              C:\Users\haryo\Desktop\enjarify-master\presensi-enjarify.jar!\com\google\android\gms\common\GoogleApiAvailability.class
