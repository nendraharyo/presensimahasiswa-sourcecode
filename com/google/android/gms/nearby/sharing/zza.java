  ...
  implements Parcelable.Creator
{
  static void zza(AppContentReceivedResult paramAppContentReceivedResult, Parcel paramParcel, int paramInt)
  {
    ...
    int j = paramAppContentReceivedResult.getVersionCode();
    zzb.zzc(paramParcel, 1, j);
    Uri localUri = paramAppContentReceivedResult.zzEJ();
    zzb.zza(paramParcel, 2, localUri, paramInt, false);
    j = paramAppContentReceivedResult.getStatusCode();
  ...
  public AppContentReceivedResult zzgq(Parcel paramParcel)
  {
    ...
    if (n < j)
    {
      ...
      for (;;)
      {
        ...
        localObject3 = (Uri)com.google.android.gms.common.internal.safeparcel.zza.zza(paramParcel, n, (Parcelable.Creator)localObject2);
        k = m;
        n = i;
    ...
    Object localObject3 = new com/google/android/gms/nearby/sharing/AppContentReceivedResult;
    ((AppContentReceivedResult)localObject3).<init>(m, (Uri)localObject2, i);
    return (AppContentReceivedResult)localObject3;
  }
