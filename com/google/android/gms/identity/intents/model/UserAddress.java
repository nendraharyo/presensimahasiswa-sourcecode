  ...
  implements SafeParcelable
{
  ...
  static
  {
    zzb localzzb = new com/google/android/gms/identity/intents/model/zzb;
    localzzb.<init>();
    CREATOR = localzzb;
  }
  ...
  public static UserAddress fromIntent(Intent paramIntent)
  {
    ...
    if (paramIntent != null)
    {
      localObject = "com.google.android.gms.identity.intents.EXTRA_ADDRESS";
    ...
    for (Object localObject = null;; localObject = (UserAddress)paramIntent.getParcelableExtra("com.google.android.gms.identity.intents.EXTRA_ADDRESS")) {
      return (UserAddress)localObject;
    }
  }
...
/* Location:              C:\Users\haryo\Desktop\enjarify-master\presensi-enjarify.jar!\com\google\android\gms\identity\intents\model\UserAddress.class
