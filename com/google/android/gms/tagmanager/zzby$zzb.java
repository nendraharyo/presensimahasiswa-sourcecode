  ...
  extends SQLiteOpenHelper
{
  ...
  private boolean zza(String paramString, SQLiteDatabase paramSQLiteDatabase)
  {
    ...
    //   7: istore 5
    //   9: iload 5
    //   11: anewarray 23	java/lang/String
    //   14: astore 6
    //   16: iconst_0
    //   17: istore 5
    //   19: aconst_null
    ...
    //   37: istore 5
    //   39: iload 5
    //   41: anewarray 23	java/lang/String
    //   44: astore 9
    //   46: iconst_0
    //   47: istore 5
    //   49: aconst_null
    ...
    //   70: aconst_null
    //   71: aconst_null
    //   72: invokevirtual 33	android/database/sqlite/SQLiteDatabase:query	(Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   75: astore 4
    //   77: aload 4
    //   79: invokeinterface 39 1 0
    //   84: istore 5
    //   86: aload 4
    //   88: ifnull +10 -> 98
    //   91: aload 4
    ...
    //   106: aconst_null
    //   107: astore 7
    //   109: new 45	java/lang/StringBuilder
    //   112: astore 4
    //   114: aload 4
    //   116: invokespecial 47	java/lang/StringBuilder:<init>	()V
    //   119: ldc 49
    //   121: astore 6
    //   123: aload 4
    //   125: aload 6
    ...
    //   145: astore 4
    //   147: aload 4
    //   149: invokestatic 63	com/google/android/gms/tagmanager/zzbg:zzaK	(Ljava/lang/String;)V
    //   152: aload 7
    //   154: ifnull +10 -> 164
    //   157: aload 7
    //   159: invokeinterface 43 1 0
    //   164: iconst_0
    //   165: istore 5
    //   167: aconst_null
    //   168: astore 7
  ...
  {
    Object localObject1 = "SELECT * FROM gtm_hits WHERE 0";
    ...
    try
    {
      ...
      if (bool)
      {
        localObject1 = "hit_url";
        bool = localHashSet.remove(localObject1);
        if (bool)
        {
          localObject1 = "hit_time";
          bool = localHashSet.remove(localObject1);
          if (bool)
          {
            localObject1 = "hit_first_send_time";
            bool = localHashSet.remove(localObject1);
            if (bool) {
              break label170;
            }
  ...
  {
    boolean bool1 = this.zzbjL;
    if (bool1)
    {
      long l1 = this.zzbjM + 3600000L;
      localObject1 = zzby.zza(this.zzbjK);
      l2 = ((zzmq)localObject1).currentTimeMillis();
      bool1 = l1 < l2;
      if (bool1)
      {
        localObject2 = new android/database/sqlite/SQLiteException;
        ((SQLiteException)localObject2).<init>("Database creation failed");
    ...
    catch (SQLiteException localSQLiteException)
    {
      for (;;)
      {
        Object localObject3 = zzby.zzc(this.zzbjK);
        localObject1 = zzby.zzb(this.zzbjK);
        localObject3 = ((Context)localObject3).getDatabasePath((String)localObject1);
...
/* Location:              C:\Users\haryo\Desktop\enjarify-master\presensi-enjarify.jar!\com\google\android\gms\tagmanager\zzby$zzb.class
