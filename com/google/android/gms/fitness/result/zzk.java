  ...
  implements Parcelable.Creator
{
  static void zza(SessionStopResult paramSessionStopResult, Parcel paramParcel, int paramInt)
  {
    ...
    int j = paramSessionStopResult.getVersionCode();
    zzb.zzc(paramParcel, 1000, j);
    Object localObject = paramSessionStopResult.getStatus();
    zzb.zza(paramParcel, 2, (Parcelable)localObject, paramInt, false);
    localObject = paramSessionStopResult.getSessions();
  ...
  public SessionStopResult zzdX(Parcel paramParcel)
  {
    ...
    Object localObject3 = new com/google/android/gms/fitness/result/SessionStopResult;
    ((SessionStopResult)localObject3).<init>(j, (Status)localObject2, (List)localObject1);
    return (SessionStopResult)localObject3;
  }
...
/* Location:              C:\Users\haryo\Desktop\enjarify-master\presensi-enjarify.jar!\com\google\android\gms\fitness\result\zzk.class
