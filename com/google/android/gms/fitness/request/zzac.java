  ...
  implements Parcelable.Creator
{
  static void zza(SessionUnregistrationRequest paramSessionUnregistrationRequest, Parcel paramParcel, int paramInt)
  {
    ...
    Object localObject = paramSessionUnregistrationRequest.getIntent();
    zzb.zza(paramParcel, 1, (Parcelable)localObject, paramInt, false);
    int j = paramSessionUnregistrationRequest.getVersionCode();
    zzb.zzc(paramParcel, 1000, j);
    localObject = paramSessionUnregistrationRequest.getCallbackBinder();
  ...
  public SessionUnregistrationRequest zzdH(Parcel paramParcel)
  {
    ...
    Object localObject3 = new com/google/android/gms/fitness/request/SessionUnregistrationRequest;
    ((SessionUnregistrationRequest)localObject3).<init>(j, (PendingIntent)localObject2, (IBinder)localObject1);
    return (SessionUnregistrationRequest)localObject3;
  }
...
/* Location:              C:\Users\haryo\Desktop\enjarify-master\presensi-enjarify.jar!\com\google\android\gms\fitness\request\zzac.class
