  ...
  implements zzlx
{
  ...
  public static zzlx zzaL(IBinder paramIBinder)
  {
    ...
    for (;;)
    {
      return (zzlx)localObject;
      localObject = paramIBinder.queryLocalInterface("com.google.android.gms.clearcut.internal.IClearcutLoggerCallbacks");
      if (localObject != null)
      {
        boolean bool = localObject instanceof zzlx;
        if (bool)
        {
          localObject = (zzlx)localObject;
          continue;
        }
      }
      localObject = new com/google/android/gms/internal/zzlx$zza$zza;
      ((zzlx.zza.zza)localObject).<init>(paramIBinder);
    }
  }
  ...
  public boolean onTransact(int paramInt1, Parcel paramParcel1, Parcel paramParcel2, int paramInt2)
  {
    ...
    Object localObject = "com.google.android.gms.clearcut.internal.IClearcutLoggerCallbacks";
    paramParcel1.enforceInterface((String)localObject);
    int j = paramParcel1.readInt();
    if (j != 0) {}
    for (localObject = (Status)Status.CREATOR.createFromParcel(paramParcel1);; localObject = null)
    {
      zzv((Status)localObject);
      j = i;
      break;
      j = 0;
    }
...
/* Location:              C:\Users\haryo\Desktop\enjarify-master\presensi-enjarify.jar!\com\google\android\gms\internal\zzlx$zza.class
