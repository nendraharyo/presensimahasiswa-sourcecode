  ...
  implements zzjp
{
  ...
  public zzjs(zzjp paramzzjp)
  {
    ...
    this.zzNN = paramzzjp;
    localObject = new com/google/android/gms/internal/zzjo;
    Context localContext = paramzzjp.zzhQ();
    ((zzjo)localObject).<init>(localContext, this, this);
    this.zzNO = ((zzjo)localObject);
    localObject = this.zzNN.zzhU();
    if (localObject != null) {
      ((zzjq)localObject).zzh(this);
    }
    localObject = this.zzNN.getView();
...
/* Location:              C:\Users\haryo\Desktop\enjarify-master\presensi-enjarify.jar!\com\google\android\gms\internal\zzjs.class
