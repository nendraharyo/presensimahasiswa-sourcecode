  ...
  public ChangesAvailableEvent zzaQ(Parcel paramParcel)
  {
    ...
    for (;;)
    {
      ...
      case 2: 
        ...
        break;
      case 3: 
        localObject1 = ChangesAvailableOptions.CREATOR;
        localObject1 = (ChangesAvailableOptions)zza.zza(paramParcel, k, (Parcelable.Creator)localObject1);
      }
    }
    ...
    ChangesAvailableEvent localChangesAvailableEvent = new com/google/android/gms/drive/events/ChangesAvailableEvent;
    localChangesAvailableEvent.<init>(j, (String)localObject2, (ChangesAvailableOptions)localObject1);
    return localChangesAvailableEvent;
  }
...
/* Location:              C:\Users\haryo\Desktop\enjarify-master\presensi-enjarify.jar!\com\google\android\gms\drive\events\zzb.class
