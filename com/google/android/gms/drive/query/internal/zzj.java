  ...
  implements Parcelable.Creator
{
  static void zza(InFilter paramInFilter, Parcel paramParcel, int paramInt)
  {
    ...
    int j = paramInFilter.mVersionCode;
    zzb.zzc(paramParcel, 1000, j);
    MetadataBundle localMetadataBundle = paramInFilter.zzauh;
    zzb.zza(paramParcel, 1, localMetadataBundle, paramInt, false);
    zzb.zzI(paramParcel, i);
  }
  
  public InFilter zzcr(Parcel paramParcel)
  {
    ...
    localInFilter.<init>(j, (MetadataBundle)localObject2);
    return localInFilter;
  }
  
  public InFilter[] zzem(int paramInt)
  {
...
/* Location:              C:\Users\haryo\Desktop\enjarify-master\presensi-enjarify.jar!\com\google\android\gms\drive\query\internal\zzj.class
