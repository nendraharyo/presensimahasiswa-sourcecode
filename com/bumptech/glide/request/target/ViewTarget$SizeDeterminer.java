...
final class ViewTarget$SizeDeterminer
{
  ...
  ViewTarget$SizeDeterminer(View paramView)
  {
  ...
  void clearCallbacksAndListener()
  {
    ...
    if (bool)
    {
      ViewTarget.SizeDeterminer.SizeDeterminerLayoutListener localSizeDeterminerLayoutListener = this.layoutListener;
  ...
  void getSize(SizeReadyCallback paramSizeReadyCallback)
  {
    ...
    for (;;)
    {
      ...
      if (localObject == null)
      {
        ...
        ViewTarget.SizeDeterminer.SizeDeterminerLayoutListener localSizeDeterminerLayoutListener = new com/bumptech/glide/request/target/ViewTarget$SizeDeterminer$SizeDeterminerLayoutListener;
...
/* Location:              C:\Users\haryo\Desktop\enjarify-master\presensi-enjarify.jar!\com\bumptech\glide\request\target\ViewTarget$SizeDeterminer.class
